...
[source,java,medium]
docker run -it -m 256M -p 9090:9090 dockerfile.jdk8.alpine.34.111
...
[source,java,medium]
docker run -it -m 512M -p 9090:9090 dockerfile.jdk8.alpine.34.111
...
[source,java,medium]
docker run -it -m 512M -p 9090:9090 -e "JAVA_PARAMS=2" dockerfile.jdk8.alpine.34.111
...
[source,java,medium]
docker run -it -m 512M -p 9090:9090 -e "JAVA_PARAMS=3" dockerfile.jdk8.alpine.34.111
...
[source,java,medium]
docker run -it -m 512M --memory-swap -1 -p 9090:9090 -e "JAVA_PARAMS=3" dockerfile.jdk8.alpine.34.111
...
[source,java,medium]
docker run -it -m 512M --memory-swap 515M -p 9090:9090 -e "JAVA_PARAMS=3" dockerfile.jdk8.alpine.34.111
...
[source,java,medium] 
docker run -it -m 512M -p 9090:9090 -e "JAVA_PARAMS=20" \
...
[source,java,medium] 
docker run -it -m 512M -p 9090:9090 -e "JAVA_PARAMS=21" \
 dockerfile.jdk8.alpine.36.131
...
docker run -it -m 512M  -p 9090:9090 \
 -e "JAVA_PARAMS=22" dockerfile.jdk8.alpine.36.131
...
=== you should always have 3 elements at least ;-)
